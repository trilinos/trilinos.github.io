...
show_sidebar: true
sidebar: nav
keywords: Trilinos capabilities, Scientific computing framework, High-performance computing tools, Performance portability, Mathematical kernels for node-local computations, Distributed-memory linear algebra, Utility and helper tools, Mesh generation, Mesh manipulation, Mesh I/O, Cell topology, Level-set methods, Mesh refinement and adaptivity, Mesh quality assessment, Mesh-based data transfer, Finite element local assembly, Finite element assembly for multiphysics systems, Field evaluation and dependency management, Meshless approximation of linear operators, Partitioning and load balancing, One-level domain decomposition, Multilevel domain decomposition, Multigrid methods, Physics-based block preconditioners, Iterative linear solvers, Direct linear solvers, Large-scale eigenvalue algorithms, Nonlinear solvers, Continuation and stability analysis, Transient solvers, Optimization solvers, Forward mode automatic differentiation, Reverse mode automatic differentiation, Uncertainty quantification, Stochastic methods, Unified solver interface, Python wrappers, Abstract numerical algorithms, Kokkos, Kokkos Kernels, Tpetra, Teuchos, PAMGEN, SEACAS, STK, Percept, Shards, Krino, Intrepid2, Panzer, Phalanx, Compadre, Zoltan, Zoltan2, Ifpack2, FROSch, MueLu, Teko, Belos, Amesos2, ShyLU, Adelus, Anasazi, NOX, LOCA, Tempus, ROL, Sacado, Stokhos, Stratimikos, PyTrilinos2, Thyra, Abstract numerical algorithms, Parallel execution, Memory management, Hierarchical parallelism, Sparse matrix operations, BLAS routines, Graph algorithms, MPI-based communication, Halo exchange, Multidimensional arrays, Mesh visualization tools, ParaView, VisIt, PDE assembly, Jacobian computation, Sensitivity analysis, Optimization algorithms, Polynomial chaos expansions, Block-structured linear systems, Ensemble-based simulations, GPU-based systems, CUDA, HIP, SYCL, Multiphysics simulations, Scalability, Leadership-class systems, Parallel computing architectures, Scientific applications, Engineering applications, Numerical analysis, Linear algebra backends, Rapid prototyping, Algorithm development, Multicore computing, Accelerator computing, Vectorized computing, HPC tools, Trilinos packages, Trilinos framework
---
